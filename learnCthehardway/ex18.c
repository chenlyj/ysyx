...
typedef int *(*SortFunction)(int *numbers,int count,compare_cb cmp);
/**
 ...
 */
void test_sorting(int *numbers, int count, SortFunction fun, compare_cb cmp)
{
    int i = 0;
    int *sorted = fun(numbers, count, cmp);
